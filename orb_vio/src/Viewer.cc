...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("TeleVision-SLAM: Map Viewer",1024,768);
    ...
    cv::namedWindow("TeleVision-SLAM: Current Frame");
    ...
    while(1)
    {
        ...
        cv::imshow("TeleVision-SLAM: Current Frame",im);
        cv::waitKey(mT);
