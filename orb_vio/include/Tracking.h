...
int tkCount;
public:
    Tracking(ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer,Map* pMap, string strSettingPath);
    Tracking(ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer,Map* pMap, string strSettingPath, cv::VideoCapture& cap);
    ...
    void SetIMU(IMUMeasurementList* _imufactor);
    ...
    ///////////////////////////////////////////////////////////
    // for debug
    void loadTimestample(char* time_file);
...
protected:
   ...
   // tf::TransformBroadcaster mTfBr;
    ...
    /////////////////////////////////////////////////////
    // for debug, store the timesmp
    vector<double> _timestample;
    int _debug_info = 0;
