...
public:
    ...
    cv::Point2f projectMapPoint(MapPoint* mp);
...
public:
    ...
    long unsigned int mnBALocalForISAM2;
    long unsigned int mnBAFixedForISAM2;
    ...
    static bool lId2(KeyFrame* pKF1, KeyFrame* pKF2){
        return pKF1->mnId>pKF2->mnId;
    }
